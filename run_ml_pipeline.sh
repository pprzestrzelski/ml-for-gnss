...
python $PREDICTION_SCRIPT $BIAS_COLUMN_NAME $PREDICTION_INPUT_FOLDER $NETWORK_FOLDER $INPUT_SIZE $PREDICTION_DEPTH $SCALING_FACTOR $PREDICTION_FOLDER $PREDICTION_ZERO_EPOCH $PREDICTION_EPOCH_STEP
fi
